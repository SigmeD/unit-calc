...
> **📊 Текущий статус:** Завершены этапы 1-3 (инфраструктура + выбор маркетплейса + модуль ввода данных). В разработке: Этап 4 (движок расчетов). Общий прогресс: ~40% от MVP.  
...
#### 4.1 Core расчеты
- [ ] Модуль формул в отдельном файле
- [ ] Мгновенный пересчет при изменении полей
- [ ] Валидация и обработка ошибок

#### 4.2 Метрики
- [ ] **CM1:** Contribution Margin после MP-затрат
- [ ] **CM2:** Contribution Margin после рекламы
- [ ] **Чистая прибыль** с единицы
- [ ] **Маржинальность** (%)
- [ ] **ROI общий** (%)
- [ ] **ROI на рекламу** (%)
- [ ] **ACOS/ДРР** (% от выручки)
- [ ] **Статус:** прибыль/убыток с цветовой индикацией

#### 4.3 Точка безубыточности
- [ ] Минимальная цена продажи (с учетом всех факторов)
- [ ] Точка безубыточности по объему (шт./месяц)
- [ ] Учет процента выкупа в формулах
...
- [ ] Детальная раскладка по статьям расходов

#### 5.2 Мини-визуализация
- [ ] График точки безубыточности
- [ ] Простая диаграмма структуры себестоимости
