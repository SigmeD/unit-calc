...
### 👤 Для пользователей
- **[Руководство пользователя](docs/user/USER_GUIDE.md)** - как пользоваться калькулятором

### 👨‍💻 Для разработчиков
- **[Руководство разработчика](docs/developer/DEVELOPER_GUIDE.md)** - настройка и разработка
- **[Техническая спецификация](docs/developer/TECH_SPEC.md)** - архитектура и API
- **[MVP Roadmap](docs/developer/MVP_ROADMAP.md)** - план развития проекта
- **[История рефакторинга](docs/developer/REFACTORING_SUMMARY.md)** - изменения в коде

### 📖 Руководства
- **[GitHub Setup & Updates](docs/guides/github/setup-and-updates.md)** - полное руководство по GitHub
- **[Git Cheatsheet](docs/guides/github/GIT_CHEATSHEET.md)** - справочник Git команд
- **[Инструкции деплоя](docs/guides/deployment/UPDATE_INSTRUCTIONS.md)** - обновление проекта

### 📊 Отчеты
- **[История багфиксов](docs/reports/BUGFIX_LOG.md)** - исправленные ошибки
- **[Отчеты тестирования](docs/reports/testing/)** - результаты тестов
- **[Roadmap оптимизации](docs/reports/optimization/OPTIMIZATION_ROADMAP.md)** - план улучшений

## 🛠️ Скрипты
Все скрипты автоматизации находятся в **[scripts/](scripts/)** - см. [описание всех скриптов](scripts/README.md)
